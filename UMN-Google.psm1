...
#region Spread Sheet API Functions
    ...
    #region New-GSheetSpreadSheet
        function New-GSheetSpreadSheet
        {
            <#
                ...
                .EXAMPLE
                    New-GSheet -properties $properties -accessToken $accessToken

                .EXAMPLE
                    New-GSheet -title 'My sheet' -accessToken $accessToken
    ...
    #region Remove-GSheetSpreadSheet
